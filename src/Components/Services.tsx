  ...
  return (
    <section id="services" className="relative w-full py-24 overflow-hidden ">
      <motion.div
        ...
        className="relative z-10 max-w-6xl mx-auto px-6 flex flex-col justify-center md:items-center gap-2"
      >
        <div className="space-y-2 md:text-center">
          ...
          <p className="text-zinc-400 max-w-2xl mt-4 leading-7">
            I build modern, responsive, and scalable digital experiences for
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
          {services.map((service) => (
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true, amount: 0.2 }}
              className="group rounded-3xl border border-white/10 bg-zinc-900/40 backdrop-blur-sm p-8 hover:border-orange-500/40 hover:-translate-y-2 transition-all duration-300  "
            >
              ...
              <h3 className="text-2xl pt-3 font-semibold mb-4 text-center group-hover:text-orange-500 transition-all ease-in-out duration-100">
                {service.title}
              </h3>
