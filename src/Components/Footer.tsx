...
const Footer = () => {
  return (
    <footer  className='border-t border-white/10 py-8 mt-12 md:mt-24'>
        ...
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} className='max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4'>
